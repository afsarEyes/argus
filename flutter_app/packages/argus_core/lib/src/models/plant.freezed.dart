...
abstract class $PlantCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String? location, bool active});
}
...
class _$PlantImpl implements _Plant {
  ...
  @override
  String toString() {
    return 'Plant(id: $id, name: $name, location: $location, active: $active)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, location, active);
