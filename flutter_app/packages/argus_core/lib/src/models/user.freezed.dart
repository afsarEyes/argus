...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, role: $role, plantId: $plantId, lineId: $lineId, shift: $shift)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, name, role, plantId, lineId, shift);
