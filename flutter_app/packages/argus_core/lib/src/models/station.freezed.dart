...
abstract class $StationCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String lineId, String name, bool active});
}
...
class _$StationImpl implements _Station {
  ...
  @override
  String toString() {
    return 'Station(id: $id, lineId: $lineId, name: $name, active: $active)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, lineId, name, active);
